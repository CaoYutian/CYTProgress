...
- (void)layoutSubviews {
    ...
    for (int i = 0; i < titleArr.count; i ++) {
        ...
        dzgBtn.frame = CGRectMake(30 + width * i, 0, width, 20);
    ...
    if ([str isEqualToString:btn.titleLabel.text]) {
        ...
        indicateBtn.frame = CGRectMake(btn.frame.size.width * ration + btn.frame.origin.x - 15, btn.frame.origin.y - 35, 30, 30);
